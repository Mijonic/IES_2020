					...
					case SupportedProfiles.Projekat:
						{
							...
							TransformAndLoadReport report = ProjekatImporter.Instance.CreateNMSDelta(concreteModel);

							if (report.Success)
							{
								nmsDelta = ProjekatImporter.Instance.NMSDelta;
								success = true;
							}
							else
							{
							...
							ProjekatImporter.Instance.Reset();
